...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    SCHEDULE_TODAY_CANCEL: '/api/schedule/today/cancel',
    SCHEDULE_WEEK: '/api/schedule/week',
    SCHEDULE_WEEKDAY: '/api/schedule/weekday',
    SCHEDULE_EXCEPTIONS: '/api/schedule/exceptions',
    SCHEDULE_TEMPLATES: '/api/schedule/templates',
    SCHEDULE_HOLIDAYS_PREVIEW: '/api/schedule/holidays/preview',
    SCHEDULE_HOLIDAYS_APPLY:   '/api/schedule/holidays/apply',
    SCHEDULE_HOLIDAYS_PENDING: '/api/schedule/holidays/pending',
    ...
    SYSTEM_LOGS_DOWNLOAD: '/api/system/logs/download',
  },
